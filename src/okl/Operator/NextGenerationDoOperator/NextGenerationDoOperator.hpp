...
namespace okl {
	/*!
	 *  @brief      次世代処理関数クラス
	 *  @details    次世代全てに指定の操作を行う関数クラス
	 *				- __Operator			操作関数クラス
	 */
	template<class __Operator>
	class NextGenerationDoOperator : public Operator
	{
	public:
		/*!
		 * @brief				コンストラクタ
		 */
		NextGenerationDoOperator() = default;

		/*!
		 * @brief				デストラクタ
		 */
		virtual ~NextGenerationDoOperator() = default;
		 ...
		 */
		static const std::string info() { return "次世代に(" + __Operator::info() + ")"; }
