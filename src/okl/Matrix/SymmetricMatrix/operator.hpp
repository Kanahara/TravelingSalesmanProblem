...
namespace okl {
	...
	*/
	...
	inline std::ostream& operator<<(std::ostream& __os, const SymmetricMatrix<__Value, __Key, __Container>& __matrix) {
		using key_type = typename SymmetricMatrix<__Value, __Key, __Container>::key_type;
